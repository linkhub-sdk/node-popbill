...
MessageService.prototype.sendMessage_MMS = function (CorpNum, Sender, SenderName, Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, UserID, success, error) {
    if (this._isNullOrEmpty(CorpNum)){
        this._throwError('팝빌회원 사업자번호가 입력되지 않았습니다.', error)
        return
    }
...
MessageService.prototype.sendMMS = function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, adsYN, requestNum, SenderName, UserID, success, error) {
    var Messages = {
        Sender: Sender,
        Receiver: Receiver,
        ReceiverName: ReceiverName,
    ...
    this.sendMessage_MMS(CorpNum, '', SenderName, '', '', Messages, FilePath, reserveDT, adsYN, requestNum, UserID, success, error);
}

BaseService.addMethod(MessageService.prototype, 'sendMMS', function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, success, error) {
    this.sendMMS(CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, false, '', '', '', success, error)
});

BaseService.addMethod(MessageService.prototype, 'sendMMS', function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, adsYN, success, error) {
    this.sendMMS(CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, adsYN, '', '', '', success, error)
});

BaseService.addMethod(MessageService.prototype, 'sendMMS', function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, adsYN, requestNum, success, error) {
    this.sendMMS(CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, adsYN, requestNum, '', '', success, error)
});

BaseService.addMethod(MessageService.prototype, 'sendMMS', function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, adsYN, requestNum, SenderName, success, error) {
    this.sendMMS(CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePath, reserveDT, adsYN, requestNum, SenderName, '', success, error)
});

MessageService.prototype.sendMMS_multi = function (CorpNum, Sender, Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, SenderName, UserID, success, error) {
    this.sendMessage_MMS(CorpNum, Sender, SenderName, Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, UserID, success, error);
}

BaseService.addMethod(MessageService.prototype, 'sendMMS_multi', function (CorpNum, Sender, Subject, Contents, Messages, FilePath, reserveDT, success, error) {
    this.sendMessage_MMS(CorpNum, Sender, '', Subject, Contents, Messages, FilePath, reserveDT, false, '', success, error);
});

BaseService.addMethod(MessageService.prototype, 'sendMMS_multi', function (CorpNum, Sender, Subject, Contents, Messages, FilePath, reserveDT, adsYN, success, error) {
    this.sendMessage_MMS(CorpNum, Sender, '', Subject, Contents, Messages, FilePath, reserveDT, adsYN, '', success, error);
});

BaseService.addMethod(MessageService.prototype, 'sendMMS_multi', function (CorpNum, Sender, Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, success, error) {
    this.sendMessage_MMS(CorpNum, Sender, '', Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, success, error);
});

BaseService.addMethod(MessageService.prototype, 'sendMMS_multi', function (CorpNum, Sender, Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, SenderName, success, error) {
    this.sendMessage_MMS(CorpNum, Sender, SenderName, Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, success, error);
});

BaseService.addMethod(MessageService.prototype, 'sendMessage_MMS', function (CorpNum, Sender, SenderName, Subject, Contents, Messages, FilePath, reserveDT, adsYN, success, error) {
    this.sendMessage_MMS(CorpNum, Sender, SenderName, Subject, Contents, Messages, FilePath, reserveDT, adsYN, '', success, error)
});

BaseService.addMethod(MessageService.prototype, 'sendMessage_MMS', function (CorpNum, Sender, SenderName, Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, success, error) {
    this.sendMessage_MMS(CorpNum, Sender, SenderName, Subject, Contents, Messages, FilePath, reserveDT, adsYN, requestNum, '',success, error)
});
