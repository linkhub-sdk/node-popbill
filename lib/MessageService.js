...
MessageService.prototype.sendSMS_multi = function (CorpNum, Sender, Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error) {
...
MessageService.prototype.sendLMS_multi = function(CorpNum, Sender, Subject, Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error){
...
MessageService.prototype.search = function(CorpNum, SDate, EDate, State, Item, ReserveYN, SenderYN, Order, Page, PerPage, QString, UserID, success, error){
    ...
    if (!this._isNullOrEmpty(ReserveYN)) {
        if (ReserveYN) targetURI += '&ReserveYN=1'
    }
