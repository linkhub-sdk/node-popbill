...
MessageService.prototype.getUnitCost = function (CorpNum, MessageType, UserID, success, error) {
    if (!MessageType || 0 === MessageType.length) {
        this._throwError(-99999999, '메시지 유형이 입력되지 않았습니다.', error);
        return;
    }
...
BaseService.addMethod(MessageService.prototype, 'getUnitCost', function (CorpNum, MessageType, success, error) {
    this.getUnitCost(CorpNum, MessageType, '', success, error);
});
...
BaseService.addMethod(MessageService.prototype, 'checkSenderNumber', function (CorpNum, SenderNumber, UserID, success, error) {
    if (!SenderNumber || 0 === SenderNumber.length) {
...
BaseService.addMethod(MessageService.prototype, 'sendSMS', function (CorpNum, Sender, Receiver, Contents, success, error) {
    var Messages = {
        Sender: Sender,
        Receiver: Receiver,
        ReceiverName: '',
    ...
    this.sendMessage('SMS', CorpNum, '', '', '', '', Messages, null, false, '', '', success, error);
});
...
BaseService.addMethod(MessageService.prototype, 'sendSMS', function (CorpNum, Sender, Receiver, ReceiverName, Contents, reserveDT, adsYN, SenderName, requestNum, UserID, success, error) {
    var Messages = {
        Sender: Sender,
        SenderName: SenderName,
        Receiver: Receiver,
...
BaseService.addMethod(MessageService.prototype, 'sendSMS_multi', function (CorpNum, Sender, Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error) {
    this.sendMessage('SMS', CorpNum, Sender, '', '', Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error);
});
...
BaseService.addMethod(MessageService.prototype, 'sendLMS', function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, reserveDT, adsYN, SenderName, requestNum, UserID, success, error) {
    var Messages = {
        Sender: Sender,
        SenderName: SenderName,
        Receiver: Receiver,
...
BaseService.addMethod(MessageService.prototype, 'sendLMS_multi', function (CorpNum, Sender, Subject, Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error) {
    this.sendMessage('LMS', CorpNum, Sender, '', Subject, Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error);
});
...
BaseService.addMethod(MessageService.prototype, 'sendXMS', function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, reserveDT, adsYN, SenderName, requestNum, UserID, success, error) {
    var Messages = {
        Sender: Sender,
        SenderName: SenderName,
        Receiver: Receiver,
...
BaseService.addMethod(MessageService.prototype, 'sendXMS_multi', function (CorpNum, Sender, Subject, Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error) {
    this.sendMessage('XMS', CorpNum, Sender, '', Subject, Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error);
});
...
BaseService.addMethod(MessageService.prototype, 'sendMessage', function (MsgType, CorpNum, Sender, SenderName, Subject, Contents, Messages, reserveDT, adsYN, requestNum, UserID, success, error) {
...
BaseService.addMethod(MessageService.prototype, 'sendMMS', function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePaths, reserveDT, adsYN, requestNum, SenderName, success, error) {
    var Messages = {
        Sender: Sender,
        Receiver: Receiver,
        ReceiverName: ReceiverName,
...
BaseService.addMethod(MessageService.prototype, 'sendMMS', function (CorpNum, Sender, Receiver, ReceiverName, Subject, Contents, FilePaths, reserveDT, adsYN, requestNum, SenderName, UserID, success, error) {
    var Messages = {
        Sender: Sender,
        Receiver: Receiver,
        ReceiverName: ReceiverName,
    ...
    this.sendMessage_MMS(CorpNum, '', '', '', '', Messages, FilePaths, reserveDT, adsYN, requestNum, UserID, success, error);
});
...
BaseService.addMethod(MessageService.prototype, 'sendMMS_multi', function (CorpNum, Sender, Subject, Contents, Messages, FilePaths, reserveDT, adsYN, requestNum, UserID, success, error) {
    this.sendMessage_MMS(CorpNum, Sender, '', Subject, Contents, Messages, FilePaths, reserveDT, adsYN, requestNum, UserID, success, error);
});
...
BaseService.addMethod(MessageService.prototype, 'sendMessage_MMS', function (CorpNum, Sender, SenderName, Subject, Contents, Messages, FilePaths, reserveDT, adsYN, requestNum, UserID, success, error) {
    if (!CorpNum || 0 === CorpNum.length) {
        this._throwError(-99999999, '팝빌회원 사업자번호가 입력되지 않았습니다.', error);
        return;
    }
...
BaseService.addMethod(MessageService.prototype, 'search', function (CorpNum, SDate, EDate, success, error) {
    this.search(CorpNum, SDate, EDate, '', '', false, false, '', '', '', '', '', success, error);
});
BaseService.addMethod(MessageService.prototype, 'search', function (CorpNum, SDate, EDate, UserID, success, error) {
    this.search(CorpNum, SDate, EDate, '', '', false, false, '', '', '', '', UserID, success, error);
});

BaseService.addMethod(MessageService.prototype, 'search', function (CorpNum, SDate, EDate, State, Item, ReserveYN, SenderYN, Order, Page, PerPage, QString, UserID, success, error) {
    ...
    var targetURI = '/Message/Search?SDate=' + SDate;
