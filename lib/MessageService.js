...
BaseService.addMethod(MessageService.prototype, 'sendLMS_multi', function(CorpNum, Sender, Subject, Contents, Messages, reserveDT, adsYN, SenderName, success, error){
...
BaseService.addMethod(MessageService.prototype, 'sendXMS_multi', function(CorpNum, Sender, Subject, Contents, Messages, reserveDT, adsYN, SenderName, success, error){
