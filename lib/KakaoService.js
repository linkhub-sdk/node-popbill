...
BaseService.addMethod(KakaoService.prototype, 'getATSTemplateMgtURL', function (CorpNum, success, error) {
    this.getATSTemplateMgtURL(CorpNum, null, success, error)
})
...
BaseService.addMethod(KakaoService.prototype, 'getSentListURL', function (CorpNum, success, error) {
    this.getSentListURL(CorpNum, null, success, error)
})
...
BaseService.addMethod(KakaoService.prototype, 'listPlusFriendID', function (CorpNum, success, error) {
    this.listPlusFriendID(CorpNum, null, success, error)
})
...
BaseService.addMethod(KakaoService.prototype, 'getSenderNumberList', function (CorpNum, success, error) {
    this.getSenderNumberList(CorpNum, null, success, error)
})
...
BaseService.addMethod(KakaoService.prototype, 'getATSTemplate', function (CorpNum, templateCode, success, error) {
    this.getATSTemplate(CorpNum, templateCode, null, success, error)
})
...
KakaoService.prototype.sendATS_one = function (
    CorpNum,
    templateCode,
    Sender,
    content,
...
BaseService.addMethod(
    KakaoService.prototype,
    'sendATS_one',
    function (CorpNum, templateCode, Sender, content, altContnet, altSendType, sndDT, receiver, receiverName, success, error) {
...
BaseService.addMethod(
    KakaoService.prototype,
    'sendATS_one',
    function (CorpNum, templateCode, Sender, content, altContnet, altSendType, sndDT, receiver, receiverName, UserID, success, error) {
        var msg = {
            rcv: receiver,
            rcvnm: receiverName,
            msg: content,
...
BaseService.addMethod(
    KakaoService.prototype,
    'sendATS_one',
    function (CorpNum, templateCode, Sender, content, altContnet, altSendType, sndDT, receiver, receiverName, UserID, requestNum, success, error) {
        var msg = {
            rcv: receiver,
            rcvnm: receiverName,
            msg: content,
...
BaseService.addMethod(
    KakaoService.prototype,
    'sendATS_one',
    function (CorpNum, templateCode, Sender, content, altContnet, altSendType, sndDT, receiver, receiverName, UserID, requestNum, btns, success, error) {
        var msg = {
            rcv: receiver,
            rcvnm: receiverName,
            msg: content,
...
KakaoService.prototype.sendATS_same = function (
    CorpNum,
    templateCode,
    Sender,
    content,
...
KakaoService.prototype.sendFTS_same = function (CorpNum, plusFriendID, Sender, content, altSubject, altContent, altSendType, sndDT, adsYN, msgs, btns, UserID, requestNum, success, error) {
    if (this._isNullOrEmpty(plusFriendID)) {
        this._throwError('카카오톡 채널 아이디가 입력되지 않았습니다.', error)
        return
    }
...
KakaoService.prototype.sendFMS_one = function (CorpNum, plusFriendID, Sender, content, altContent, altSendType, sndDT, receiver, receiverName, adsYN, imageURL, FilePath, btns, UserID, requestNum, success, error) {
    this.sendFMS_one(CorpNum, plusFriendID, Sender, content, null, altContent, altSendType, sndDT, receiver, receiverName, adsYN, imageURL, FilePath, btns, UserID, requestNum, success, error)
}
...
KakaoService.prototype.cancelReserve = function (CorpNum, ReceiptNum, UserID, success, error) {
    if (this._isNullOrEmpty(ReceiptNum)) {
        this._throwError('카카오톡 접수번호가 입력되지 않았습니다.', error)
        return
    }
    this._executeAction({
...
KakaoService.prototype.cancelReserveRN = function (CorpNum, RequestNum, UserID, success, error) {
    if (this._isNullOrEmpty(RequestNum)) {
        this._throwError('카카오톡 전송요청번호를 입력하지 않았습니다.', error)
        return
    }
    this._executeAction({
...
KakaoService.prototype.search = function (CorpNum, SDate, EDate, State, Item, ReserveYN, SenderYN, Page, PerPage, Order, QString, UserID, success, error) {
    ...
    if (this._isNullOrEmpty(State)) targetURI += '&ReserveYN=' + ReserveYN
...
BaseService.addMethod(KakaoService.prototype, 'search', function (CorpNum, SDate, EDate, State, Item, ReserveYN, SenderYN, Page, PerPage, Order, success, error) {
    this.search(CorpNum, SDate, EDate, State, Item, ReserveYN, SenderYN, Page, PerPage, Order, null, success, error)
})
...
BaseService.addMethod(KakaoService.prototype, 'search', function (CorpNum, SDate, EDate, State, Item, ReserveYN, SenderYN, Page, PerPage, Order, UserID, success, error) {
    this.search(CorpNum, SDate, EDate, State, Item, ReserveYN, SenderYN, Page, PerPage, Order, null, UserID, success, error)
})
...
BaseService.addMethod(KakaoService.prototype, 'getUnitCost', function (CorpNum, KakaoType, success, error) {
    this.getUnitCost(CorpNum, KakaoType, null, success, error)
})
...
BaseService.addMethod(KakaoService.prototype, 'getChargeInfo', function (CorpNum, KakaoType, success, error) {
    this.getChargeInfo(CorpNum, KakaoType, null, success, error)
})
