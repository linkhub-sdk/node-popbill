...
BaseService.addMethod(KakaoService.prototype, 'sendATS_one', function (CorpNum, templateCode, snd, content, altContnet, altSendType, sndDT, receiver, receiverName, UserID, success, error) {
    ...
    this.sendATS_multi(CorpNum, templateCode, snd, content, altContnet, altSendType, sndDT, msg, UserID, success, error);
});
...
BaseService.addMethod(KakaoService.prototype, 'sendATS_same', function (CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, UserID, success, error) {
    ...
    this.sendATS_multi(CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msg, UserID, success, error);
});

//SendATS multi
BaseService.addMethod(KakaoService.prototype, 'sendATS_multi', function (CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, success, errpr) {
    this.sendATS_multi(CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, '', success, errpr)
});
//SendATS multi (UserID)
BaseService.addMethod(KakaoService.prototype, 'sendATS_multi', function (CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, UserID, success, error) {
...
BaseService.addMethod(KakaoService.prototype, 'sendFTS_one', function (CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, receiver, receiverName, adsYN, btns, UserID, success, error) {
    ...
    this.sendFTS_multi(CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, msg, btns, success, error);
});
...
BaseService.addMethod(KakaoService.prototype, 'sendFTS_same', function (CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, msgs, btns, UserID, success, error) {
    ...
    this.sendFTS_multi(CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, msg, btn, UserID, success, error);

});

//SendFTS multi
BaseService.addMethod(KakaoService.prototype, 'sendFTS_multi', function (CropNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, msgs, btns, success, error) {
    this.sendFTS_multi(CropNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, msgs, btns, "", success, error);
});
//SendFTS multi (UserID)
BaseService.addMethod(KakaoService.prototype, 'sendFTS_multi', function (CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, msgs, btns, UserID, success, error) {
    if (!CorpNum || 0 === CorpNum.length) {
        this._throwError(-99999999, '팝빌회원 사업자번호가 입력되지 않았습니다.', error);
        return;
    }
...
BaseService.addMethod(KakaoService.prototype, "sendFMS_one", function (CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, receiver, receiverName, adsYN, imageURL, FilePath, btns, UserID, success, error) {
    ...
    this.sendFMS_multi(CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, imageURL, FilePath, msg, btns, UserID, success, error);
});
...
BaseService.addMethod(KakaoService.prototype, "sendFMS_same", function (CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, imageURL, FilePath, msgs, btns, UserID, success, error) {
    ...
    this.sendFMS_multi(CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, imageURL, FilePath, msg, btn, UserID, success, error);
});

//SenddFMS multi
BaseService.addMethod(KakaoService.prototype, "sendFMS_multi", function (CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, imageURL, FilePath, msgs, btns, success, error) {
    this.sendFMS_multi(CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, imageURL, FilePath, msgs, btns, "", success, error);
});
//SenddFMS multi (UserID)
BaseService.addMethod(KakaoService.prototype, "sendFMS_multi", function (CorpNum, plusFriendID, snd, content, altContent, altSendType, sndDT, adsYN, imageURL, FilePath, msgs, btns, UserID, success, error) {
    if (!CorpNum || 0 === CorpNum.length) {
        this._throwError(-99999999, '팝빌회원 사업자번호가 입력되지 않았습니다.', error);
        return;
    }
