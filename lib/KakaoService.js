...
BaseService.addMethod(KakaoService.prototype, 'getATSTemplate', function (CorpNum, templateCode, UserID, success, error) {
    this._executeAction({
        uri: '/KakaoTalk/GetATSTemplate/' + templateCode,
        CorpNum: CorpNum,
        UserID: UserID,
        Method: 'GET',
        success: function (response) {
...
BaseService.addMethod(KakaoService.prototype, 'sendATS_one', function (CorpNum, templateCode, snd, content, altContnet, altSendType, sndDT, receiver, receiverName, success, error) {
    this.sendATS_one(CorpNum, templateCode, snd, content, altContnet, altSendType, sndDT, receiver, receiverName, "", "", null, success, error);
});
//SendATS one (UserID)
...
//SendATS multi
BaseService.addMethod(KakaoService.prototype, 'sendATS_multi', function (CorpNum, templateCode, snd, altSendType, sndDT, msgs, success, error) {
    this.sendATS_multi(CorpNum, templateCode, snd, altSendType, sndDT, msgs, "", "", success, error)
});
...
BaseService.addMethod(KakaoService.prototype, 'sendATS_multi', function (CorpNum, templateCode, snd, altSendType, sndDT, msgs, UserID, success, error) {
    this.sendATS_multi(CorpNum, templateCode, snd, altSendType, sndDT, msgs, UserID, "", success, error)
});
...
//SendATS same
BaseService.addMethod(KakaoService.prototype, 'sendATS_same', function (CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, success, error) {
    this.sendATS_same(CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, "", "", null, success, error)
});
...
BaseService.addMethod(KakaoService.prototype, 'sendATS_same', function (CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, UserID, success, error) {
    this.sendATS_same(CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, UserID, "", null, success, error)
});
...
BaseService.addMethod(KakaoService.prototype, 'sendATS_same', function (CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, UserID, requestNum, success, error) {
  this.sendATS_same(CorpNum, templateCode, snd, content, altContent, altSendType, sndDT, msgs, UserID, requestNum, null, success, error)
});
