...
function EncryptPublicKeyInfo() {
    function setkeyId(params) {this.keyId = params;}
    function setkeyName(params) {this.keyName = params;}
    function setPublicKey(params) {this.publicKey = addAnnotation(params);}
    function valid(){
        if(!this.keyId){
