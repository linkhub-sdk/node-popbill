...
class EncryptPublicKeyInfo {
    constructor(){}
    setkeyId(params) {this.keyId = params;}
    setkeyName(params) {this.keyName = params;}
    setPublicKey(params) {this.publicKey = addAnnotation(params);}
    valid(){
        if(!this.keyId){
