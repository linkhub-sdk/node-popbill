...
FaxService.prototype.resendFax = function(CorpNum, ReceiptNum, Sender, SenderName, Receiver, ReceiverName, ReserveDT, Title, RequestNum, UserID, success, error) {
    var options = {
...
FaxService.prototype.resendFaxRN= function(CorpNum, OrgRequestNum, Sender, SenderName, Receiver, ReceiverName, ReserveDT, Title, RequestNum, UserID,success, error) {
    var options = {
        SenderNum: Sender,
        SenderName: SenderName,
        Receiver: Receiver,
...
FaxService.prototype.search = function(CorpNum, SDate, EDate, State, ReserveYN, SenderOnly, Order, Page, PerPage, QString, UserID, success, error) {
    ...
    if (!this._isNullOrEmpty(State)) targetURI += '&State=' + State
    if (ReserveYN != null) {
        if (ReserveYN) {
