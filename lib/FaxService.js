...
BaseService.addMethod(Service.prototype, 'getFaxResult', function (CorpNum, ReceiptNum, success, error) {
...
BaseService.addMethod(Service.prototype, 'getFaxResultRN', function (CorpNum, RequestNum, success, error) {
