...
BaseService.addMethod(BizInfoCheckService.prototype,'checkBizInfo' , function(UserCorpNum, CheckCorpNum, success, error){
    this.checkBizInfo(UserCorpNum, CheckCorpNum, '', success, error)
});

BaseService.addMethod(BizInfoCheckService.prototype,'checkBizInfo', function(UserCorpNum, CheckCorpNum, UserID, success, error){
