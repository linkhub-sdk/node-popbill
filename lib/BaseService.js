...
BaseService.prototype.getPopbillURL = function(CorpNum,UserID,TOGO,callback,err) {
  this._executeAction({
    uri : '/?TG=' + TOGO,
    CorpNum : CorpNum,
    UserID : UserID,
...
BaseService.prototype.registContact = function(CorpNum,UserID,ContactInfo,callback,err){
  var postData = linkhub.stringify(ContactInfo);
...
BaseService.prototype.updateCorpInfo = function(CorpNum,UserID,CorpInfo,callback,err){
