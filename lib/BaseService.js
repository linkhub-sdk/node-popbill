...
BaseService.addMethod(BaseService.prototype, 'getPaymentURL', function (CorpNum, callback, err) {
    this.getPaymentURL(CorpNum, '', callback, err);
});

BaseService.addMethod(BaseService.prototype, 'getPaymentURL', function (CorpNum, UserID, callback, err) {
    this._executeAction({
        uri: '/?TG=PAYMENT',
        CorpNum: CorpNum,
        UserID: UserID,
...
BaseService.addMethod(BaseService.prototype, 'getUseHistoryURL', function (CorpNum, callback, err) {
    this.getUseHistoryURL(CorpNum, '', callback, err);
});

BaseService.addMethod(BaseService.prototype, 'getUseHistoryURL', function (CorpNum, UserID, callback, err) {
    this._executeAction({
        uri: '/?TG=USEHISTORY',
        CorpNum: CorpNum,
        UserID: UserID,
...
BaseService.addMethod(BaseService.prototype, 'getContactInfo', function (CorpNum, ContactID, callback, err) {
    this.getContactInfo(CorpNum, ContactID, '', callback, err);
});

BaseService.addMethod(BaseService.prototype, 'getContactInfo', function (CorpNum, ContactID, UserID, callback, err) {
...
BaseService.prototype._executeAction = function (options) {
    ...
    Token(function (token) {
        ...
        headers['User-Agent'] = 'NODE POPBILL SDK'
...
BaseService.addMethod(BaseService.prototype, 'paymentRequest',
...
BaseService.addMethod(BaseService.prototype, 'getSettleResult',
...
BaseService.addMethod(BaseService.prototype, 'getRefundHistory', function (CorpNum, Page, success, error) {
    this.getRefundHistory(CorpNum, Page, null, null, success, error);
});
BaseService.addMethod(BaseService.prototype, 'getRefundHistory', function (CorpNum, success, error) {
    this.getRefundHistory(CorpNum, null, null, null, success, error);
});
...
BaseService.addMethod(BaseService.prototype, 'getPaymentHistory', function (CorpNum, SDate, EDate, Page, success, error) {
    this.getPaymentHistory(CorpNum, SDate, EDate, Page, null, null, success, error);
});
BaseService.addMethod(BaseService.prototype, 'getPaymentHistory', function (CorpNum, SDate, EDate, success, error) {
    this.getPaymentHistory(CorpNum, SDate, EDate, null, null, null, success, error);
});
...
BaseService.addMethod(BaseService.prototype, 'getUseHistory', function (CorpNum, SDate, EDate, Page, PerPage, success, error) {
    this.getUseHistory(CorpNum, SDate, EDate, Page, PerPage, null, null, success, error);
});
BaseService.addMethod(BaseService.prototype, 'getUseHistory', function (CorpNum, SDate, EDate, Page, success, error) {
    this.getUseHistory(CorpNum, SDate, EDate, Page, null, null, null, success, error);
});
BaseService.addMethod(BaseService.prototype, 'getUseHistory', function (CorpNum, SDate, EDate, success, error) {
    this.getUseHistory(CorpNum, SDate, EDate, null, null, null, null, success, error);
});

// 회원 탈퇴
BaseService.prototype.QuitMember = function (CorpNum, QuitReason, UserID, success, error) {
    var postData = this._stringify({
...
BaseService.addMethod(BaseService.prototype, 'GetRefundInfo', function (CorpNum, RefundCode, success, error) {
    this.GetRefundableBalance(CorpNum, RefundCode, null, success, error);
});