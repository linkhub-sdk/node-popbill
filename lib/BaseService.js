...
BaseService.addMethod(
  ...
  "getPaymentURL",
    function (CorpNum, success, error) {
      this.getPaymentURL(CorpNum, "", success, error);
  }
);
...
BaseService.prototype.listContact = function (CorpNum, success, error) {
  this._executeAction({
    uri: "/IDs",
    Method: "GET",
    CorpNum: CorpNum,
...
BaseService.addMethod(
  BaseService.prototype,
  "registContact",
    function (CorpNum, UserID, ContactInfo, success, error) {
    var postData = linkhub.stringify(ContactInfo);
...
BaseService.addMethod(
  BaseService.prototype,
  "getContactInfo",
    function (CorpNum, ContactID, UserID, success, error) {
...
BaseService.addMethod(
  BaseService.prototype,
  "updateCorpInfo",
    function (CorpNum, CorpInfo, success, error) {
...
BaseService.addMethod(
  BaseService.prototype,
  "updateCorpInfo",
    function (CorpNum, UserID, CorpInfo, success, error) {
