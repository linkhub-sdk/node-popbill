...
BaseService.prototype.getPartnerURL = function(CorpNum, TOGO, success, error) {
    ...
    if (this._isNullOrEmpty(TOGO)) {
        this._throwError('TOGO가 입력되지 않았습니다.', error)
        return
    }
...
BaseService.prototype._IsValidDT = function(date){
    return /(\d{4})(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])(0[0-9]|2[0-3])([0-5][0-9])([0-5][0-9])/.test(date)
}