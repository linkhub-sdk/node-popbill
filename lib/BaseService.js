...
BaseService.addMethod(Service.prototype, "paymentRequest", function (CorpNum, PaymentForm, UserID, success, error) {
...
BaseService.addMethod(Service.prototype, "getSettleResult", function (CorpNum, settleCode, UserID, success, error) {
...
BaseService.addMethod(Service.prototype, "refund", function (CorpNum, RefundForm, UserID, success, error) {
...
BaseService.addMethod(Service.prototype, "getRefundHistory", function (CorpNum, Page, PerPage, UserID, success, error) {
...
BaseService.addMethod(Service.prototype, "getPaymentHistory", function (CorpNum, SDate, EDate, Page, PerPage, UserID, success, error) {
...
BaseService.addMethod(Service.prototype, "getUseHistory", function (CorpNum, SDate, EDate, Page, PerPage, Order, UserID, success, error) {
    var url = "/UseHistory"
    url += "?SDate=" + !SDate ? "" : SDate
    url += "&EDate=" + !EDate ? "" : EDate
    url += "&Page=" + !Page ? "" : Page
