...
BaseService.addMethod(TaxinvoiceService.prototype, "issue", function(CorpNum, KeyType, MgtKey, UserID, success, error){
    this.issue(CorpNum,KeyType,MgtKey,"","",false,UserID,success,error);
});
...
BaseService.addMethod(TaxinvoiceService.prototype, "issue", function(CorpNum, KeyType, MgtKey, Memo, ForceIssue, success, error) {
  this.issue(CorpNum,KeyType,MgtKey,Memo,"",ForceIssue,"",success,error)
});
...
BaseService.addMethod(TaxinvoiceService.prototype, "issue", function(CorpNum, KeyType, MgtKey, Memo, EmailSubject, ForceIssue, success, error){
  this.issue(CorpNum,KeyType,MgtKey,Memo,EmailSubject,ForceIssue,"",success,error);
});
