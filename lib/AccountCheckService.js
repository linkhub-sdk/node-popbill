...
BaseService.addMethod(AccountCheckService.prototype, 'getChargeInfo', function (CorpNum, serviceType, success, error) {
    this.getChargeInfo(CorpNum, serviceType, '', success, error);
});
