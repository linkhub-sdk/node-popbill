...
BaseService.addMethod(EasyFinBankService.prototype, 'deleteBankAccount', function (CorpNum, BankCode, AccountNumber, callback, err) {
    this.deleteBankAccount(CorpNum, BankCode, AccountNumber, '', callback, err);
});

BaseService.addMethod(EasyFinBankService.prototype, 'deleteBankAccount', function (CorpNum, BankCode, AccountNumber, UserID, callback, err) {
...
BaseService.addMethod(EasyFinBankService.prototype, 'updateBankAccount', function (CorpNum, BankCode, AccountNumber, BankAccountInfo, callback, err) {
    this.updateBankAccount(CorpNum, BankAccountInfo, '', callback, err);
});


BaseService.addMethod(EasyFinBankService.prototype, 'updateBankAccount', function (CorpNum, BankCode, AccountNumber, BankAccountInfo, UserID, callback, err) {
    if (!BankCode || 0 === BankCode.length) {
        this._throwError(-99999999, '기관코드가 입력되지 않았습니다.', err);
        return;
    }
