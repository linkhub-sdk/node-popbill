...
//     });
//
// statementService.updateEmailConfig('1234567890', "SMT_ACCEPT", true, "",
//     function(response){
//         console.log(response);
//     }, function(error){
//         console.log(error);
//     });
//
// statementService.listEmailConfig('1234567890',
//     function(response){
//         console.log(response);
//     }, function(error){
//         console.log(error);
...
const request = https.get(url2, function(res) {
  ...
  res.on('data', function(chunk) {
    ...
    if(res.statusCode == 200) {
      ...
      statementService.attachFileBinary('1234567890', '121', '20250811-01', BinaryFiles, '',
          function (response) {
              console.log(response);
          }, function (error) {
              console.log(error);
